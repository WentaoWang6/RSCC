...
AckMessage::AckMessage(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->flowId = 0;
    this->destAddress = 0;
    this->expectedSeq = 0;
...
AckMessage::AckMessage(const AckMessage& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
void AckMessage::copy(const AckMessage& other)
{
    ...
    this->expectedSeq = other.expectedSeq;
    this->sackNo = other.sackNo;
    this->ack = other.ack;
    this->lastPkt = other.lastPkt;
    this->dupAck = other.dupAck;
}
...
void AckMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->expectedSeq);
    doParsimPacking(b,this->sackNo);
    doParsimPacking(b,this->ack);
    doParsimPacking(b,this->lastPkt);
    doParsimPacking(b,this->dupAck);
}
...
void AckMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->expectedSeq);
    doParsimUnpacking(b,this->sackNo);
    doParsimUnpacking(b,this->ack);
    doParsimUnpacking(b,this->lastPkt);
    doParsimUnpacking(b,this->dupAck);
}

uint32_t AckMessage::getFlowId() const
{
    return this->flowId;
}

void AckMessage::setFlowId(uint32_t flowId)
{
    this->flowId = flowId;
}

uint32_t AckMessage::getDestAddress() const
{
    return this->destAddress;
}

void AckMessage::setDestAddress(uint32_t destAddress)
{
    this->destAddress = destAddress;
}

uint32_t AckMessage::getExpectedSeq() const
{
    return this->expectedSeq;
}

void AckMessage::setExpectedSeq(uint32_t expectedSeq)
{
    this->expectedSeq = expectedSeq;
}

uint32_t AckMessage::getSackNo() const
{
    return this->sackNo;
}

void AckMessage::setSackNo(uint32_t sackNo)
{
    this->sackNo = sackNo;
}

bool AckMessage::getAck() const
{
    return this->ack;
}

void AckMessage::setAck(bool ack)
{
    this->ack = ack;
}

bool AckMessage::getLastPkt() const
{
    return this->lastPkt;
}

void AckMessage::setLastPkt(bool lastPkt)
{
    this->lastPkt = lastPkt;
}

bool AckMessage::getDupAck() const
{
    return this->dupAck;
}

void AckMessage::setDupAck(bool dupAck)
{
    this->dupAck = dupAck;
}
...
AckMessageDescriptor::AckMessageDescriptor() : omnetpp::cClassDescriptor("mine::AckMessage", "omnetpp::cPacket")
{
...
int AckMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='e' && strcmp(fieldName, "expectedSeq")==0) return base+2;
    if (fieldName[0]=='s' && strcmp(fieldName, "sackNo")==0) return base+3;
    if (fieldName[0]=='a' && strcmp(fieldName, "ack")==0) return base+4;
    if (fieldName[0]=='l' && strcmp(fieldName, "lastPkt")==0) return base+5;
    if (fieldName[0]=='d' && strcmp(fieldName, "dupAck")==0) return base+6;
...
int AckMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *AckMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string AckMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 2: return ulong2string(pp->getExpectedSeq());
        case 3: return ulong2string(pp->getSackNo());
        case 4: return bool2string(pp->getAck());
        case 5: return bool2string(pp->getLastPkt());
        case 6: return bool2string(pp->getDupAck());
        default: return "";
    }
}

bool AckMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 2: pp->setExpectedSeq(string2ulong(value)); return true;
        case 3: pp->setSackNo(string2ulong(value)); return true;
        case 4: pp->setAck(string2bool(value)); return true;
        case 5: pp->setLastPkt(string2bool(value)); return true;
        case 6: pp->setDupAck(string2bool(value)); return true;
